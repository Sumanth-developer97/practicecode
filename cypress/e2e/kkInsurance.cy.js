describe("Insurance E2E testing", function() {
    it("E2E action", function() {
        cy.visit("https://insure.kandkinsurance.com/sites/ASClubs/Pages/Activity-Program.aspx");
        ...
        cy.window().then((win) => {
            ...
            // Perform actions after ensuring jQuery is available
            cy.get('#ctl00_LoginLeftPanelUserControl_drpPrograms').select('Activity & Social Clubs');
            cy.get("#ctl00_LoginLeftPanelUserControl_btnGo").click();
            ...
            cy.get('#ctl00_WebPartManager_g_b816503e_1a4a_4f48_a174_a9dcffb7899d_ctl00_ddlState').select('Alabama');
            cy.get('#ctl00_WebPartManager_g_b816503e_1a4a_4f48_a174_a9dcffb7899d_ctl00_ddlPrimaryStateFacility').select('Alaska');
            ...
            cy.get('#ctl00_WebPartManager_g_95de283d_9fd8_4ef2_ad88_424bab7dc82e_ctl00_ctlAddtionalInsured_cboStateList').select('Alabama');
            ...
            cy.get('#ctl00_WebPartManager_g_95de283d_9fd8_4ef2_ad88_424bab7dc82e_ctl00_ctlAddtionalInsured_btn_Add').should('be.visible').click({ force: true });
            cy.wait(4000);
            cy.get('#ctl00_WebPartManager_g_95de283d_9fd8_4ef2_ad88_424bab7dc82e_ctl00_ctlAddtionalInsured_btn_Continue').should('be.visible').click({ force: true });
            ...
            cy.get('#ctl00_WebPartManager_g_8b1010ba_faa2_431b_8768_e814142d16b5_ctl00_DropDownList_Relation').select('Owner');
